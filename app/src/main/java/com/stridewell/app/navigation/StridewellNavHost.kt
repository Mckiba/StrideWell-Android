...
fun StridewellNavHost(
    ...
    LaunchedEffect(launchState) {
        when (launchState) {
            LaunchViewModel.LaunchState.Loading -> Unit // splash is still showing
    ...
    // 401 anywhere in the app → clear back stack → WelcomeScreen
    LaunchedEffect(Unit) {
    ...
    NavHost(
        ...
        startDestination = Route.Welcome.path,   // immediately replaced by LaunchedEffect above
        modifier         = modifier,
